                                ...
                                <div class="space-y-5">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex-1 text-right">
                                            <a href="/forgot-password" class="text-brand-500 hover:text-brand-600 dark:text-brand-400 text-sm">
                                                Forgot password?
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 gap-3 sm:gap-5">
                                        <a href="{{ route('auth.google') }}"
                                            ...
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                ...
                                                <path
                                                    d="M18.7511 10.1944C18.7511 9.47495 18.6915 8.94995 18.5626 8.40552H10.1797V11.6527H15.1003C15.0011 12.4597 14.4654 13.675 13.2749 4.4916L13.2582 14.6003L15.9087 16.6126L16.0924 16.6305C17.7788 15.1041 18.7511 12.8583 18.7511 10.1944Z"
                                                    fill="#4285F4" />
                                                <path
            ...
            <div class="bg-brand-950 relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="/" class="mb-4 flex items-center gap-2 font-bold text-4xl tracking-tight text-white">
                            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" class="text-teal-400">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Custom Printing Reimagined. Design and print your vision with ease.
                        </p>
                    </div>
                </div>
            </div>
