    ...
    <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
        ...
        >
            <div class="px-6 pt-8 pb-6 sm:p-10 sm:pb-8">
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-4 text-center sm:mt-0 sm:ml-6 sm:text-left">
                        <h3 class="text-xl font-bold leading-6 text-gray-900 dark:text-white" id="modal-title">Authentication Required</h3>
                        <div class="mt-3">
            ...
            <div class="bg-gray-50 dark:bg-gray-900/50 px-6 py-5 sm:flex sm:flex-row-reverse sm:px-10 gap-3">
                <a href="{{ route('signin') }}" wire:navigate class="inline-flex w-full justify-center rounded-xl bg-brand-500 px-6 py-3 text-sm font-bold text-white shadow-sm hover:bg-brand-600 transition-colors sm:w-auto active:scale-95">
                    Sign In
                </a>
                <button 
                    type="button" 
