    ...
    >
        <span class="mr-3 overflow-hidden rounded-full h-11 w-11 flex items-center justify-center bg-gray-100 dark:bg-gray-800">
            @if(auth()->check() && auth()->user()->image)
                ...
                <img style="display: none;" src="/images/user/owner.png" alt="{{ auth()->user()->name ?? 'User' }}" class="h-full w-full object-cover" />
            @else
                <img src="/images/user/owner.png" alt="{{ auth()->user()->name ?? 'User' }}" class="h-full w-full object-cover" />
            @endif
        </span>
